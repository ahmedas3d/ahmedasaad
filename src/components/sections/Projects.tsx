...
import { getFeaturedProjects, getProjectCategories, getProjectsByCategory } from '../../data/projects';
import { FaExternalLinkAlt, FaGithub, FaCode, FaMobile, FaPlay } from 'react-icons/fa';
...
const Projects: React.FC = () => {
  ...
  const getProjectKey = (title: string): 'sportify' | 'homeFood' | 'newsHub' | 'scholarChat' | 'flowery' => {
    const titleMap: { [key: string]: 'sportify' | 'homeFood' | 'newsHub' | 'scholarChat' | 'flowery' } = {
      'Sportify': 'sportify',
      'Home Food': 'homeFood',
      'News Hub': 'newsHub',
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-light-text-secondary dark:text-dark-text-secondary max-w-2xl mx-auto">
            Explore my mobile applications built with Flutter, showcasing clean architecture and modern development practices
          </p>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      <div className="flex flex-wrap gap-2">
                        ...
                        {project.technologies.length > project.primaryTech.length && (
                          <span className="px-2 py-1 bg-primary-red text-white text-xs font-code rounded-md">
                            +{project.technologies.length - project.primaryTech.length} more
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-xs font-code text-light-text-muted dark:text-dark-text-muted mb-4">
                      <span>Team: {project.teamSize} member{project.teamSize > 1 ? 's' : ''}</span>
        ...
        >
          <div className="card p-8 max-w-2xl mx-auto">
            ...
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6">
              Let's discuss your mobile app project and bring your ideas to life with Flutter.
            </p>
            <motion.button
              onClick={() => {
