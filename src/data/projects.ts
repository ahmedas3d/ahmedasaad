...
class NewsRepositoryImpl implements NewsRepository {
  ...
  },
  {
    ...
    subtitle: "E-commerce Platform",
    description:
      " It is an application that speeds up the in-store purchasing process.",
    longDescription:
      "It is an application that speeds up the in-store purchasing process. The user can scan the products he wants to buy and add them to the cart, then go to the checkout and pay for the products without the need for a cashier.",
    category: "E-commerce & Retail",
    subcategory: "E-commerce App",
    technologies: [
      "Flutter",
    ...
    primaryTech: ["Flutter", "REST API", "E-commerce"],
    features: [
      "Product catalog with categories",
      "Advanced search and filtering",
      "Shopping cart management",
    ...
    images: {
      thumbnail: `${BASE_URL}/assets/images/projects/sf/thumbnail.jpg`,
      hero: `${BASE_URL}/assets/images/projects/sf/hero.jpg`,
      gallery: [
        `${BASE_URL}/assets/images/projects/sf/catalog.jpg`,
        `${BASE_URL}/assets/images/projects/sf/product-detail.jpg`,
        `${BASE_URL}/assets/images/projects/sf/cart.jpg`,
        `${BASE_URL}/assets/images/projects/sf/checkout.jpg`,
      ],
    },
    links: {
      github: "",
    ...
    featured: true,
    priority: 5,
    tags: ["Flutter", "E-commerce", "REST API", "Payment","SQL", "Shopping"],
    year: 2025,
  },
];
